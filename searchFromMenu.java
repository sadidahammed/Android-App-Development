...
public class searchFromMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_from_menu);
        ...
        ArrayAdapter<String> locationAdapter = new ArrayAdapter<>(searchFromMenu.this, android.R.layout.simple_spinner_item, locations);
        ...
        ArrayAdapter<String> vehicleAdapter = new ArrayAdapter<>(searchFromMenu.this, android.R.layout.simple_spinner_item, vehicle);
        ...
        showListVehicle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedLocation.equals("Select Area")){
                    Toast.makeText(searchFromMenu.this, "Please select area first.", Toast.LENGTH_SHORT).show();
                }else{
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(searchFromMenu.this, profile_menu.class);
